module.exports = function (router) {
    ...
    router.get('/mofyss/zhuantilanmu/dfzgl/:category?', require('./mofyss/zhuantilanmu/dfzgl/article'));
    router.get('/ndrc/zcfb/:category?', require('./ndrc/zcfb'));
    router.get('/mofwww/zhengwuxinxi/zhengcefabu', require('./mofwww/zhengwuxinxi/zhengcefabu'));
    router.get('/www/zhengce/wenjian/zhongyang', require('./www/zhengce/wenjian/zhongyang'));
    router.get('/zhengzhou/zrzyhghj/:category?', require('./zhengzhou/zrzyhghj'));
